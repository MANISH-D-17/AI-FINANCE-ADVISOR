...
const STATS = [
  ...
  { label: 'Wealth Plans Created', value: '48K' },
];
    ...
    <div style={{ display: 'flex', minHeight: '100vh', width: '100%', overflow: 'hidden', backgroundColor: '#F5F5F5' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            Your<br />Wealth<br />Works<br />Here.
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7, delay: 0.15 }}
            style={{ color: 'rgba(255,255,255,0.4)', fontSize: '1rem', fontWeight: 500, lineHeight: 1.6, maxWidth: '22rem' }}
          >
            AI-powered capital allocation, transaction intelligence, and wealth architecture — all in one terminal.
          </motion.p>
          ...
          >
            {STATS.map((s, i) => (
              <div key={i}>
                <p style={{ fontSize: '1.5rem', fontWeight: 700, color: 'white', lineHeight: 1 }}>{s.value}</p>
                <p style={{ fontSize: '10px', fontWeight: 900, color: 'rgba(255,255,255,0.25)', textTransform: 'uppercase', letterSpacing: '0.2em', marginTop: '0.35rem' }}>{s.label}</p>
              </div>
            ))}
          </motion.div>
        </div>
        ...
        >
          <div style={{ marginBottom: '2.5rem' }}>
            ...
            <p style={{ color: 'rgba(0,0,0,0.4)', fontSize: '0.9rem', fontWeight: 500 }}>
              Access your intelligence terminal
            </p>
          </div>
          ...
          <p style={{ textAlign: 'center', fontSize: '0.85rem', color: 'rgba(0,0,0,0.4)', marginTop: '2rem', fontWeight: 500 }}>
            ...
            <Link to="/register" style={{ color: '#0A0A0A', fontWeight: 800, textDecoration: 'none', borderBottom: '1px solid rgba(0,0,0,0.2)' }}>
              Create an account
            </Link>
          </p>
        </motion.div>
